...
class EpisodeDetailFactory: CreateEpisodeDetailView {
    ...
    private func createViewModel(episodeDetailInfo: EpisodeListPresentableItem) -> EpisodeDetailViewModel {
        return EpisodeDetailViewModel(episodeDetailInfo: episodeDetailInfo,
                                      getSingleCharacter: createUseCase(),
    ...
    private func createRepository() -> SingleCharacterRepositoryType {
        return SingleCharacterRepository(apiDataSource: createAPIDataSource(),
                                         ...
                                         cacheDataSource: EpisodeDetailFactory.createCacheDataSource())
    }
