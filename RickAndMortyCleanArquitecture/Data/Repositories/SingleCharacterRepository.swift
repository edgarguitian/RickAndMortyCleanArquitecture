...
class SingleCharacterRepository: SingleCharacterRepositoryType {
    ...
    init(apiDataSource: APISingleCharacterDataSourceType, errorMapper: RickAndMortyDomainErrorMapper, cacheDataSource: CacheCharacterDataSourceType) {
    ...
    func getSingleCharacter(characterId: String) async -> Result<Character, RickAndMortyDomainError> {
        // TODO: meter cacheo de single character
